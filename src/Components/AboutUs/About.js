  ...
  return (
    <div>
      <Container>
        ...
        <p>
          WELCOME TO Fragrancy DIRECT, THE BANGLADESH PREMIER ONLINE FRAGRANCE &
          BEAUTY STORE.
        </p>
        ...
        <div className="row my-5 about-intro">
          <div className="col-md-6">
            <h4>Our Company</h4>
            <p>
              We have built an extensive global network of brands and suppliers
              which enables us to source the latest fragrance at a great price
              ,which is the reason. We are able to keep our prices low.
            </p>
            <ul>
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="about-gol">
              ...
              <h4>Our Mission</h4>
              <p>
                TO SUPPLY THE BIGGEST FRAGRANCE & COSMETICS BRANDS AT AFFORDABLE
                PRICES.
              </p>
            </div>
          </div>
